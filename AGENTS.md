...
> This file governs how the LLM (Codex) maintains the trading wiki.
...
3. **`AGENTS.md`** (this file) — The schema. Defines structure, conventions, and workflows.
...
ai-trading, machine-learning, backtesting, data-provider
```
