...
2. **`CLAUDE.md`** (this file) — The schema. Defines structure, conventions, and workflows. `AGENTS.md` is the same schema addressed to other coding agents; keep the two in sync.
