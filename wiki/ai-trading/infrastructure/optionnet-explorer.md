...
- **Volatility surface display** — view IV by strike and expiry, with skew and term-structure overlays. Less polished than [[livevol|LiveVol Pro]] or [[orats]] but adequate for retail planning.
...
This pricing places ONE between free broker tooling (where the [[thinkorswim]] analyse tab and the [[tastytrade-platform|tastytrade]] curve view are sufficient for many traders) and institutional analytics (where [[livevol|Cboe LiveVol Pro]] starts at several times the price).
...
For a small advisory or family-office shop running discretionary options income, ONE is often the **single most important piece of analytical software** in the workflow, paired only with the broker platform and a market-data terminal. For purely systematic shops it is less central; programmatic backtests on [[orats]] or [[livevol|LiveVol]] data are the better fit.

## Related

- [[orats]] — programmatic backtester and richer IV-surface data; complement, not substitute.
- [[cboe-livevol]] / [[livevol]] — institutional alternative with deeper data but no equivalent time-and-price grid for portfolio planning.
...
- [[interactive-brokers]] — Risk Navigator overlaps in portfolio-Greeks aggregation.
