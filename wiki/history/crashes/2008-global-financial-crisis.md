...
The 2008 Global Financial Crisis was the most severe financial and economic meltdown since the [[great-depression]]. What began as a housing bubble fueled by reckless [[subprime-mortgage]] lending cascaded into a full-blown systemic crisis that brought the global financial system to the brink of collapse. The crisis destroyed trillions of dollars in wealth, triggered the deepest recession in decades, and permanently reshaped how traders think about [[risk-management]], [[correlation]], and [[liquidity]].

## Origins: The Subprime Mortgage Bubble
...
The crisis was a chain reaction. Each link below converted a manageable problem into a systemic one:

| Cause | Mechanism | Consequence |
|---|---|---|
| Low [[interest-rates]] + global savings glut | Cheap credit chasing yield | Housing demand and leverage inflate a bubble |
...
U.S. unemployment rose from 4.7% in late 2007 to 10% in October 2009. Approximately 3.8 million foreclosures were filed in 2010 alone. Over 400 U.S. banks failed between 2008 and 2012.
...
| TED spread (counterparty stress) | ~0.5% normal | ~4.6% (Oct 2008) | ~9× |
...
The crisis led to the passage of the [[dodd-frank-act]] (2010), the most sweeping financial regulation since the 1930s. Key provisions included the Volcker Rule (restricting proprietary trading by banks), creation of the Consumer Financial Protection Bureau, and enhanced oversight of [[derivatives]]. The "[[too-big-to-fail]]" debate became central to financial policy, with regulators designating certain institutions as systemically important.

## Why It Matters for Traders

The 2008 crisis provides essential lessons that remain relevant for every active trader:

1. **Correlation goes to 1 in crises**: Assets that appear uncorrelated in normal markets become highly correlated during panics. [[portfolio-diversification]] fails precisely when you need it most.
2. **[[liquidity]] evaporates**: [[bid-ask-spreads]] widen dramatically, and markets that seem liquid can become untradeable overnight. [[position-sizing]] must account for worst-case [[liquidity-risk]].
3. **[[counterparty-risk]] is real**: Even major financial institutions can fail. This lesson was later echoed in the [[ftx-collapse]].
4. **[[leverage]] kills**: Firms with excessive [[leverage]] — Bear Stearns, Lehman, and many hedge funds — were the first to fall.
5. **Government intervention changes the game**: Understanding [[central-bank]] policy and political responses is essential for [[macro-trading]].
6. **[[tail-risk]] is underpriced**: Models based on normal distributions consistently underestimate the probability and severity of extreme events, a concept explored in [[nassim-taleb]]'s work on [[black-swan]] events.

## Lessons for Traders (the durable playbook)

Beyond the headline lessons above, the GFC crystallized rules that recur in every subsequent stress event ([[covid-crash|COVID 2020]], regional-bank stress, the [[ftx-collapse]]):

- **Size for the gap, not the average.** The damaging moves were overnight gaps and frozen markets, not orderly intraday drift. [[position-sizing]] and stops must assume liquidity can vanish.
- **Stress-test for regime change, not historical volatility.** A 25-year backtest contained no nationwide house-price decline; the model's worst case was milder than reality. Tail scenarios must be imagined, not just sampled.
- **Watch the plumbing.** Funding-market signals (TED spread, repo rates, cross-currency basis) flashed red before equities fully broke. Stress in the *financing* layer leads price.
- **Forced sellers create the bottom — and the opportunity.** Deleveraging cascades drove indiscriminate selling; the March 2009 low rewarded those with dry powder and the temperament to deploy it. Crises transfer assets from the over-levered to the patient.
- **Policy is a tradable variable.** [[quantitative-easing]], rate cuts, and bailouts reshaped every asset's path. Reading the [[central-bank]] reaction function became part of the job for any [[macro-trading|macro trader]].
...
- [[leverage]] · [[counterparty-risk]] · [[liquidity-risk]] · [[tail-risk]] · [[black-swan]] — the risk concepts it taught
- [[dot-com-bubble]] · [[great-depression]] · [[ftx-collapse]] — other reference crises

## Sources

- General market knowledge; no specific wiki source ingested yet.
- Financial Crisis Inquiry Commission, *Final Report* (2011) — official US government inquiry into the causes.
- Federal Reserve and S&P historical data — S&P 500 levels (peak 1,565 Oct 2007; trough 666 Mar 2009), TED spread, unemployment.
- Michael Lewis, *The Big Short* (2010); Andrew Ross Sorkin, *Too Big to Fail* (2009) — narrative histories.
