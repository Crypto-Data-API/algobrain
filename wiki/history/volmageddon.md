...
- **Short vol with long-vol overlay** -- the [[itpm-framework|institutional configuration]] -- absorbed the shock. The overlay's [[vega]] gain (front-month VIX calls trebled in price; 25-delta SPX puts went up 5-10x) covered the bulk of the strangle loss. Books survived to continue compounding.
