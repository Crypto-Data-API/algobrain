...
The amateur investor possesses a structural advantage over Wall Street: firsthand exposure to products and trends, freedom from career and committee risk, and the ability to act on small- and mid-cap ideas that institutions are too large or too cautious to touch. Combined with modest homework — reading the report, understanding the business, and watching earnings — this "edge of the obvious" lets individuals spot great companies early, often years before the analysts do. The fortunes are made in [[tenbagger|tenbaggers]] held with patience, not in frantic trading.

## Structure and Section Themes

- **Part I — Preparing to invest.** Honest self-assessment; the case that amateurs can beat pros; distinguishing investing from gambling; the "is the market overpriced?" trap.
- **Part II — Picking winners.** Where to find ten-baggers (in your own life and workplace); the six company categories and how each behaves; "the perfect stock" characteristics (dull name, boring business, spinoff, low institutional ownership, insider buying, buybacks); the numbers that matter; the two-minute drill on a company's "story."
- **Part III — The long-term view.** Designing a portfolio; the best time to buy and sell each category; the twelve "silliest things people say about stock prices"; options, futures, and shorting (which Lynch warns against for most).

## The Six Categories

| Category | Examples | Lynch's approach |
|----------|----------|------------------|
| **Slow growers** | Mature utilities, large old industrials | Buy for dividends; modest expectations |
| **Stalwarts** | Coca-Cola, Procter & Gamble | Solid 30–50% gains; trim and rotate |
| **Fast growers** | Small aggressive firms growing 20–25%+ | The [[tenbagger]] hunting ground; watch the runway |
| **Cyclicals** | Autos, airlines, steel, chemicals | Timing the cycle is everything; P/E logic inverts |
| **Turnarounds** | Distressed firms with recovery potential | High risk/reward; tied to a specific fix |
| **Asset plays** | Hidden real estate, cash, brands, NOLs | Value buried on the balance sheet the market ignores |
...
| **Avoid hot tips / "whisper stocks"** | Exciting, speculative stories usually lose money; boring consistent growers win. |

## Criticisms and Limitations

- **The era was unusually favorable.** Magellan rode the 1980s small-cap and consumer-stock boom; many critics argue Lynch's framework is harder to replicate in a more efficient, institutionally crowded market.
- **"Buy what you know" can mislead.** Liking a product is not a thesis; the maxim is widely misread as license to skip the homework Lynch actually insists on. Familiarity can breed unwarranted confidence.
- **Light on risk and position sizing.** Compared with quant frameworks, the book says little about drawdowns, correlation, or [[risk-management]] beyond diversification-by-category.
- **Survivorship/hindsight framing.** Examples are chosen with the benefit of knowing which stocks worked; the base rate of amateur stock-picking is far less rosy.
- **EMH challenge.** Proponents of the [[efficient-market-hypothesis]] (see [[a-random-walk-down-wall-street]]) argue the average amateur is better served by [[index-investing]] than by stock selection.
...
**8/10** — The most accessible and practical stock-picking book ever written. Lynch's track record gives his advice unimpeachable credibility. Some examples are dated (1980s companies), but the principles are timeless. The PEG ratio and stock classification system remain widely used today.
