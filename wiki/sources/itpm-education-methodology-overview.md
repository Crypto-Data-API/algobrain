---
title: "ITPM — Education & Methodology Overview"
type: source
created: 2026-04-07
updated: 2026-06-12
status: good
tags: [itpm, education, methodology, long-short-equity, options, fundamental-analysis, technical-analysis]
source_type: article
...
10. [MEDIUM] 12-week structured programs with weekly mentor calls, requiring 8-12 hours per week. (Source: ITPM website)
11. [MEDIUM] Key focus areas: portfolio construction, timing within overall strategy, correlation dynamics, options structuring, continuous idea generation, news flow management, and managing trading as a business. (Source: ITPM website)
12. [MEDIUM] Students provided with spreadsheets and PDFs for practical implementation. (Source: ITPM website)

### Institute Trader Requirements

13. [MEDIUM] Minimum $25,000 USD deposit on margin. Accounts remain in trader's name with "Read Only" Institute access. (Source: ITPM website)
14. [MEDIUM] Institute monitors track records continuously and intervenes if "bad habits" develop. (Source: ITPM website)
15. [MEDIUM] "Community of educated retail traders, not a managed fund." (Source: ITPM website)

### Mentor Profiles

16. [MEDIUM] **[[anton-kreil]]**: Opened trading account at 16. Goldman Sachs (2000-2004), prop book grew from $25M to $400M+. Traded TMT, Banks, Insurance, Pharma, Biotech. Number 1-2 global market share in all traded sectors. Known as "big situation trader" specializing in macro and earnings surprises. Then Lehman Brothers and JP Morgan running global Pharma/Biotech/Chemicals. Retired May 2007. Founded ITPM 2011. Manages 1,400+ traders across 30+ countries. (Source: ITPM website bio)
17. [MEDIUM] **Jason McDonald**: PPE degree from Oxford (Magdalen College, 1992). Career at BZW, CSFB hedge fund, MAKO Volatility Hedge Fund, Commerzbank (multi-billion Euro portfolio), Lehman Brothers and TD Bank ($250M global long/short). Retired 2009. ITPM Senior Trading Mentor since 2013. (Source: ITPM website bio)
18. [MEDIUM] **[[edward-shek]]**: B.Sc Physics, King's College London. Goldman Sachs (1994-2003) across London, Tokyo, New York — convertible bonds, warrants, equities. European equities $100M long/short. Cazenove (2006-2009) — traded profitably through the 2008-2009 crisis. JP Morgan (2009-2019) — emerging markets, South Africa, CEEMEA. Multiple $100M long/short portfolios. ITPM Senior Trading Mentor running 3-month mentoring programs. (Source: ITPM website bio)

### Career Data Points

19. [MEDIUM] Kreil was "first of 400 students to receive formal job offer from investment bank trading desk" at University of Manchester. (Source: ITPM website bio — self-reported)
20. [MEDIUM] Goldman Sachs: Kreil completed both Analyst Program (2000) and Associate Program (2002) in New York, then ran dual proprietary trader / market maker function on Pan European desks from London. (Source: ITPM website bio — self-reported)
21. [MEDIUM] Edward Shek's profitable trading through 2008-2009 crisis is described as "an experience very few traders in the world managed to trade through profitably." (Source: ITPM website bio — promotional framing)
22. [MEDIUM] ITPM has consultancy contracts with hedge funds globally who pay to hire ITPM-trained traders. (Source: referenced in multiple video sources)
...
- https://itpm.com/education/
- https://itpm.com/mentor/anton-kreil/
- https://itpm.com/mentor/jason-mcdonald/
- https://itpm.com/mentor/edward-shek/
