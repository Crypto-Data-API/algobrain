...
Uranium has no liquid exchange-traded futures market comparable to oil or copper; pricing is dominated by long-term utility contracts and a thin spot market:
...
### Historical Booms and Busts

- **1970s boom**: Decade-long uranium surge driven by cost-of-living crisis and nuclear power buildout. US went from <20 to 75 nuclear reactors. Current conditions draw comparisons to this period.
- **2007 bubble**: Price hit ATH of $140 USD/oz after Cigar Lake flood (largest high-grade uranium reserve flooded, mine offline for 4 years). Supply shock sent prices soaring.
- **2008-2011 bust**: GFC crash followed by 2011 Fukushima disaster (Japan shut all reactors). Chernobyl legacy prolonged negative sentiment for decades.
- **2020-present surge**: Post-COVID supply disruption + renewed nuclear interest as low-carbon energy. Price tripled from ~$29 to $100+.
...
- **US ban on Russian uranium** (May 2024): Biden admin banned imports, allocated $2.7B for domestic supply. Existing contracts allow Russian purchases until 2028.
- **Sapporo-5 alliance**: US, France, UK, Japan, Canada agreed to strengthen nuclear fuel capacity to reduce Russian dependence.
- **China**: Building 22 of the 58 global reactors currently under construction. Electricity demand rose 6.4% in 2023.
- **Increasing demand countries**: Indonesia, Philippines, Venezuela, Saudi Arabia, UK, India, Mexico, Iraq.
- **Decreasing demand**: Germany, Pakistan, South Africa, France, Ukraine, Russia.

## Australian Context

Australia has 67% fossil fuel and 33% renewable electricity. Nuclear power is banned domestically. Uranium is mined for export only.
...
- **Kazatomprom** (LSIN:KAP) — Massive Kazakhstan-based producer, 6% dividend
- **Cameco Corporation** (NYSE:CCJ) — Canadian distribution and fuel services, P/E 136
- **NexGen Energy** (NYSE:NXE) — Canadian producer, fundamentals weak despite rising price

## Alternatives Comparison

| Source | Notes |
|--------|-------|
| **Thorium** | Abundant alternative but harder to prepare, higher melting point, higher risks |
| **Wind** | 200 turbines needed to match 1 nuclear reactor. Location-specific, land-consuming |
| **Solar** | 10x cheaper to install, but only ~30% daily production (89 days solar ≈ 341 days nuclear annualised) |
| **Hydro** | Reliable, low operating costs, 100-year lifespan, but limited locations |
| **Fossil fuels** | Millions die annually from air pollution. 1.4M lives saved 1971-2009 by switching to nuclear |

Nuclear has the highest energy output per land required and lowest CO2 of all current options.

## 2025-2026 Developments

Spot U3O8 has held roughly in the **$80-$95/lb** range through early-to-mid 2026, well above the depressed prior-cycle averages of the 2010s but below the early-2024 spike toward $100+. Key themes:
