...
related: ["[[blackrock]]", "[[crypto-markets]]", "[[ethereum]]", "[[real-world-assets]]", "[[solana]]"]
---
...
| Metric | Value |
|---|---|
| **All-Time High** | $115.90 (2026-07-15) |
| **Current vs ATH** | +0.00% |
| **All-Time Low** | $95.09 (2023-03-22) |
| **Current vs ATL** | +21.89% |
| **24h Change** | +0.01% |
| **7d Change** | +0.06% |
| **30d Change** | +0.28% |
| **1y Change** | +3.66% |
