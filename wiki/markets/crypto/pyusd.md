...
| **Categories** | Stablecoins, USD Stablecoin, Solana Ecosystem, Arbitrum Ecosystem, Ethereum Ecosystem, Starknet Ecosystem, Stellar Ecosystem, Fiat-backed Stablecoin, Made in USA |
| **Website** | [https://www.paypal.com/us/digital-wallet/manage-money/crypto/pyusd](https://www.paypal.com/us/digital-wallet/manage-money/crypto/pyusd) |
...
| **Circulating Supply** | 2.77B PYUSD |
| **Total Supply** | 2.77B PYUSD |
| **Max Supply** | None (elastic; mint/redeem 1:1) |
| **Fully Diluted Valuation** | $2.77B |
| **Market Cap / FDV Ratio** | 1.00 |

> **Supply note:** PYUSD supply is elastic and fully reserved — it grows with USD deposits and shrinks with redemptions, so MC = FDV by construction and there is no dilution/unlock dynamic. Outstanding supply fell from ~$3.96B (Apr 2026) to ~$2.77B (Jun 2026), a notable contraction in adoption-proxy float.
...
> Price stays pinned near $1.00; the ATH/ATL extremes are transient liquidity dislocations, not trend moves.
...
| Stellar | `CCCRWH6Q3FNP3I2I57BDLM5AFAT7O6OF6GKQOC6SSJNDAVRZ57SPHGU2` |
| Arbitrum One | `0x46850ad61c2b7d64d08c9c754f45254596696984` |
...
|---|---|---|
| Kraken | PYUSD/USD | N/A |
| Bitget | PYUSD/USDT | N/A |
| KuCoin | PYUSD/USDT | N/A |
| Crypto.com Exchange | PYUSD/USD | N/A |

### Decentralized Exchanges

| Exchange | Pair | Type |
|---|---|---|
| Orca | 2B1KV6DKPANXD5IXFNXCPJXMKWQJJAYMCZFHSFU24GXO/EPJFWDD5AUFQSSQEM2QN1XZYBAPC8G4WEGGKZWYTDT1V | Spot |
| Uniswap V3 (Ethereum) | 0X6C3EA9036406852006290770BEDFCABA0E23A0E8/0XA0B86991C6218B36C1D19D4A2E9EB0CE3606EB48 | Spot |
...
|---|---|
| **Website** | [https://www.paypal.com/us/digital-wallet/manage-money/crypto/pyusd](https://www.paypal.com/us/digital-wallet/manage-money/crypto/pyusd) |
| **Twitter** | [@PayPal](https://twitter.com/PayPal) |
| **Whitepaper** | [https://developer.paypal.com/dev-center/pyusd/](https://developer.paypal.com/dev-center/pyusd/) |
...
- **August 2023** — PYUSD launches on [[ethereum|Ethereum]], the first stablecoin from a major US financial institution.
- **May 2024** — PYUSD expands to [[solana|Solana]] for faster, cheaper transactions; later added on Arbitrum and Stellar.
- **December 2024** — snapshot ATL of $0.959 (a brief secondary-market dislocation).
- **April 2026** — snapshot ATH of $1.081; outstanding supply peaks near ~$3.96B.
- **June 2026** — supply contracts to ~$2.77B (rank #36) amid an "Established Bear Market" (Fear & Greed 23); peg holds at ~$1.00.
