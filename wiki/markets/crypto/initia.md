...
**Initia** (INIT) is a network for interwoven optimistic rollups; we are holistically rebuilding how the multichain system should look, feel, and operate. It ranks **#956** by market capitalization.
...
| **Market Cap Rank** | #956 |
| **Market Cap** | $14.98M |
| **Current Price** | $0.0809 |
| **Categories** | Infrastructure, Smart Contract Platform, Binance Launchpool, Layer 1 (L1), Osmosis Ecosystem, YZi Labs (Prev. Binance Labs) Portfolio, Initia Ecosystem |
| **Website** | [https://initia.xyz/](https://initia.xyz/) |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 185.21M INIT |
| **Total Supply** | 1.00B INIT |
| **Max Supply** | 1.00B INIT |
| **Fully Diluted Valuation** | $80.87M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $1.42 (2025-05-13) |
| **Current vs ATH** | -94.32% |
| **All-Time Low** | $0.0584 (2026-02-06) |
| **Current vs ATL** | +38.47% |
| **24h Change** | -2.16% |
| **7d Change** | +2.49% |
| **30d Change** | -1.55% |
| **1y Change** | +0.00% |
...
|---|---|
| Initia | `uinit` |
| Osmosis | `ibc/DD7EA9AF1E58E9FDD7F9810976817E203D5B87BAEF7AEA592FA34DF73310620B` |
...
|---|---|---|
| Binance | INIT/USDT | N/A |
| Kraken | INIT/USD | N/A |
| Upbit | INIT/BTC | N/A |
| Bitget | INIT/USDT | N/A |
| KuCoin | INIT/USDT | N/A |
| Crypto.com Exchange | INIT/USD | N/A |

### Decentralized Exchanges

| Exchange | Pair | Type |
|---|---|---|
| [[hyperliquid|Hyperliquid]] | INIT-PERP | Perpetual |
...
|---|---|
| **Website** | [https://initia.xyz/](https://initia.xyz/) |
| **Twitter** | [@initiaFDN](https://twitter.com/initiaFDN) |
| **Discord** | [https://discord.com/invite/initia](https://discord.com/invite/initia) |
| **Whitepaper** | [https://docs.initia.xyz/](https://docs.initia.xyz/) |
...
An AI agent connected to the [[cryptodataapi-mcp|CryptoDataAPI MCP]] can trade INIT-PERP end-to-end:

- **Live state** — `GET /api/v1/hyperliquid/summary?coin=INIT` (mark, funding, OI in one call); order-book depth via `GET /api/v1/hyperliquid/l2-book?coin=INIT`
- **Per-coin regime & sizing** — `GET /api/v1/quant/coins/INIT` for this coin's HMM regime state; batch sizing across a book via `GET /api/v1/quant/coins/risk?horizon=24h` (vol-target multiplier)
- **Backtest** — `GET /api/v1/backtesting/funding?symbol=INIT&exchange=hyperliquid` (hourly funding since 2023-05 or listing) and `GET /api/v1/backtesting/klines` (Hyperliquid daily candles back to the 2023 launch or listing; 1m bars since 2026-03-30)
