...
related: ["[[crypto-markets]]", "[[ethereum]]", "[[hashnote-usyc]]", "[[ousg]]", "[[real-world-assets]]", "[[tokenized-treasuries]]"]
---
...
| **Market Cap** | $118.02M |
| **Current Price** | $1.02 |
| **Categories** | Tokenized Assets, Real World Assets (RWA), Tokenized Treasuries |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 115.84M THBILL |
| **Total Supply** | 115.84M THBILL |
| **Max Supply** | Unlimited |
| **Fully Diluted Valuation** | $118.02M |
...
| **Current vs ATH** | -8.34% |
| **All-Time Low** | $0.9066 (2025-10-10) |
| **Current vs ATL** | +12.38% |
| **24h Change** | +0.00% |
| **7d Change** | +0.38% |
| **30d Change** | +0.20% |
| **1y Change** | +0.00% |
...
| Exchange | Pair | Type |
|---|---|---|
| Uniswap V3 (Ethereum) | 0X5FA487BCA6158C64046B2813623E20755091DA0B/0XA0B86991C6218B36C1D19D4A2E9EB0CE3606EB48 | Spot |
...
|---|---|
| **Website** | [https://theo.xyz](https://theo.xyz) |
| **Twitter** | [@theo_network](https://twitter.com/theo_network) |
| **GitHub** | [https://github.com/theo-network](https://github.com/theo-network) |
