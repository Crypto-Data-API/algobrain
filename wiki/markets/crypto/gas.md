...
| **Market Cap** | $68.63M |
| **Current Price** | $1.05 |
| **Categories** | Infrastructure, Smart Contract Platform |
| **Website** | [https://neo.org/](https://neo.org/) |
...
| Metric | Value |
|---|---|
| **All-Time High** | $91.94 (2018-01-15) |
| **Current vs ATH** | -98.85% |
| **All-Time Low** | $0.6213 (2020-03-13) |
| **Current vs ATL** | +70.30% |
| **24h Change** | +0.56% |
| **7d Change** | +1.96% |
| **30d Change** | -9.16% |
| **1y Change** | -67.39% |
...
|---|---|---|
| Binance | GAS/USDT | N/A |
| Kraken | GAS/USD | N/A |
| Upbit | GAS/KRW | N/A |
| Bitget | GAS/USDT | N/A |
| KuCoin | GAS/USDT | N/A |
| Crypto.com Exchange | GAS/USD | N/A |
