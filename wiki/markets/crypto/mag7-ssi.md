...
| Metric | Value |
|---|---|
| **Circulating Supply** | 168.24M MAG7.SSI |
| **Total Supply** | 168.24M MAG7.SSI |
| **Max Supply** | Unlimited |
| **Fully Diluted Valuation** | $71.53M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $1.35 (2024-12-27) |
| **Current vs ATH** | -68.39% |
| **All-Time Low** | $0.3768 (2026-06-26) |
| **Current vs ATL** | +12.86% |
| **24h Change** | -0.52% |
| **7d Change** | +2.84% |
| **30d Change** | -4.02% |
| **1y Change** | -52.43% |
...
|---|---|
| **24h Volume** | $289,131.00 |
| **Market Cap Rank** | #337 |
| **24h Range** | $0.4235 — $0.4334 |
