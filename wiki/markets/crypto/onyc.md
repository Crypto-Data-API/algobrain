...
| **Market Cap** | $224.82M |
| **Current Price** | $1.12 |
| **Categories** | Real World Assets (RWA), Yield-Bearing Stablecoin |
| **Website** | [https://onre.finance](https://onre.finance) |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 200.24M ONYC |
| **Total Supply** | 200.24M ONYC |
| **Max Supply** | Unlimited |
| **Fully Diluted Valuation** | $224.82M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $1.12 (2026-07-13) |
| **Current vs ATH** | -0.07% |
| **All-Time Low** | $1.00 (2025-07-24) |
| **Current vs ATL** | +11.71% |
| **24h Change** | -0.01% |
| **7d Change** | +0.14% |
| **30d Change** | +0.92% |
| **1y Change** | +11.25% |
...
| Exchange | Pair | Type |
|---|---|---|
| Orca | 5Y8NV33VV7WBNLFQ3ZBCKSDYPRK7G2KOIQOE7M2TCXP5/EPJFWDD5AUFQSSQEM2QN1XZYBAPC8G4WEGGKZWYTDT1V | Spot |
...
|---|---|
| **Website** | [https://onre.finance](https://onre.finance) |
| **Twitter** | [@onrefinance](https://twitter.com/onrefinance) |
| **GitHub** | [https://github.com/onre-finance](https://github.com/onre-finance) |
