...
**Xai** (XAI) was developed to enable real economies and open trade in the next generation of video games. With Xai, potentially billions of traditional gamers can own and trade valuable in-game items in their favorite games for the first time, without the need to use crypto-wallets. It ranks **#929** by market capitalization.
...
| **Market Cap Rank** | #929 |
| **Market Cap** | $16.08M |
| **Current Price** | $0.007767 |
| **Categories** | Smart Contract Platform, Gaming (GameFi), NFT, Binance Launchpool, Layer 3 (L3), Gaming Blockchains |
| **Website** | [https://xai.games/](https://xai.games/) |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 2.01B XAI |
| **Total Supply** | 2.17B XAI |
| **Max Supply** | 2.50B XAI |
| **Fully Diluted Valuation** | $20.53M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $1.59 (2024-02-25) |
| **Current vs ATH** | -99.40% |
| **All-Time Low** | $0.00878089 (2026-02-28) |
| **Current vs ATL** | +7.99% |
| **24h Change** | -0.31% |
| **7d Change** | +3.39% |
| **30d Change** | +2.48% |
...
| Chain | Address |
|---|---|
| Arbitrum One | `0x4cb9a7ae498cedcbb5eae9f25736ae7d428c9d66` |
...
|---|---|---|
| Binance | XAI/USDT | N/A |
| Bitget | XAI/USDT | N/A |
| KuCoin | XAI/USDT | N/A |
| Crypto.com Exchange | XAI/USD | N/A |

### Decentralized Exchanges

| Exchange | Pair | Type |
|---|---|---|
| [[hyperliquid|Hyperliquid]] | XAI-PERP | Perpetual |
...
|---|---|
| **Website** | [https://xai.games/](https://xai.games/) |
| **Twitter** | [@XAI_GAMES](https://twitter.com/XAI_GAMES) |
| **Telegram** | [XaiSentryNodes](https://t.me/XaiSentryNodes) (16,413 members) |
| **Discord** | [https://discord.com/invite/xaigames](https://discord.com/invite/xaigames) |
| **Whitepaper** | [https://xai-foundation.gitbook.io/xai-network/xai-blockchain/welcome-to-xai](https://xai-foundation.gitbook.io/xai-network/xai-blockchain/welcome-to-xai) |
...
| **24h Volume** | $6.01M |
| **Market Cap Rank** | #929 |
| **24h Range** | $0.00938456 — $0.00971587 |
...
An AI agent connected to the [[cryptodataapi-mcp|CryptoDataAPI MCP]] can trade XAI-PERP end-to-end:

- **Live state** — `GET /api/v1/hyperliquid/summary?coin=XAI` (mark, funding, OI in one call); order-book depth via `GET /api/v1/hyperliquid/l2-book?coin=XAI`
- **Per-coin regime & sizing** — `GET /api/v1/quant/coins/XAI` for this coin's HMM regime state; batch sizing across a book via `GET /api/v1/quant/coins/risk?horizon=24h` (vol-target multiplier)
- **Backtest** — `GET /api/v1/backtesting/funding?symbol=XAI&exchange=hyperliquid` (hourly funding since 2023-05 or listing) and `GET /api/v1/backtesting/klines` (Hyperliquid daily candles back to the 2023 launch or listing; 1m bars since 2026-03-30)
