...
| **Categories** | Decentralized Exchange (DEX), Smart Contract Platform, Exchange-based Tokens, Layer 1 (L1) |
| **Website** | [https://www.coinex.org/](https://www.coinex.org/) |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 2.47B CET |
| **Total Supply** | 2.47B CET |
| **Max Supply** | 10.00B CET |
| **Fully Diluted Valuation** | $31.66M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $0.1503 (2018-07-03) |
| **Current vs ATH** | -91.48% |
| **All-Time Low** | $0.00410696 (2018-12-15) |
| **Current vs ATL** | +211.92% |
| **24h Change** | -2.12% |
| **7d Change** | -1.04% |
| **30d Change** | -31.74% |
| **1y Change** | -78.44% |
...
|---|---|
| **24h Volume** | $44,115.00 |
| **Market Cap Rank** | #615 |
| **24h Range** | $0.0127 — $0.0131 |
