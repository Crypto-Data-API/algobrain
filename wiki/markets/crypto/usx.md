...
| Metric | Value |
|---|---|
| **Circulating Supply** | 522.89M USX |
| **Total Supply** | 522.89M USX |
| **Max Supply** | Unlimited |
| **Fully Diluted Valuation** | $522.75M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $1.17 (2026-07-14) |
| **Current vs ATH** | -14.87% |
| **All-Time Low** | $0.8285 (2025-12-26) |
| **Current vs ATL** | +20.67% |
| **24h Change** | -0.01% |
| **7d Change** | -0.01% |
| **30d Change** | +0.03% |
| **1y Change** | +0.00% |
...
|---|---|
| **24h Volume** | $893,480.00 |
| **Market Cap Rank** | #99 |
| **24h Range** | $0.9996 — $0.9999 |
