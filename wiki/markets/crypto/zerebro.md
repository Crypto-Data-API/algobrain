...
**Zerebro** (ZEREBRO) is an autonomous AI system crafted to create, distribute, and analyze content across decentralized and social platforms. Functioning independently of human oversight, Zerebro shapes cultural and financial narratives through self-propagating content that merges fiction with reality, known as hyperstition. It ranks **#570** by market capitalization.
...
| **Categories** | Meme, Solana Meme, AI Meme, Binance Alpha Spotlight |
| **Website** | [https://zerebro.org](https://zerebro.org) |
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 999.95M ZEREBRO |
| **Total Supply** | 999.95M ZEREBRO |
| **Max Supply** | 1.00B ZEREBRO |
...
| Metric | Value |
|---|---|
| **All-Time High** | $0.7841 (2025-01-02) |
| **Current vs ATH** | -95.59% |
| **All-Time Low** | $0.00580864 (2024-11-03) |
| **Current vs ATL** | +495.82% |
| **24h Change** | -1.78% |
| **7d Change** | -8.93% |
| **30d Change** | +42.55% |
| **1y Change** | +3.62% |
...
| Chain | Address |
|---|---|
| Solana | `8x5VqbHA8D7NkD52uNuS5nnt3PwA8pLD34ymskeSo2Wn` |
...
|---|---|---|
| Kraken | ZEREBRO/USD | N/A |
| KuCoin | ZEREBRO/USDT | N/A |

### Decentralized Exchanges

| Exchange | Pair | Type |
|---|---|---|
| Orca | 8X5VQBHA8D7NKD52UNUS5NNT3PWA8PLD34YMSKESO2WN/SO11111111111111111111111111111111111111112 | Spot |
...
|---|---|
| **Website** | [https://zerebro.org](https://zerebro.org) |
| **Twitter** | [@0xzerebro](https://twitter.com/0xzerebro) |
| **Telegram** | [zerebro0x](https://t.me/zerebro0x) (11,320 members) |
| **Whitepaper** | [https://arxiv.org/abs/2410.23794](https://arxiv.org/abs/2410.23794) |
...
An AI agent connected to the [[cryptodataapi-mcp|CryptoDataAPI MCP]] can trade ZEREBRO-PERP end-to-end:

- **Live state** — `GET /api/v1/hyperliquid/summary?coin=ZEREBRO` (mark, funding, OI in one call); order-book depth via `GET /api/v1/hyperliquid/l2-book?coin=ZEREBRO`
- **Per-coin regime & sizing** — `GET /api/v1/quant/coins/ZEREBRO` for this coin's HMM regime state; batch sizing across a book via `GET /api/v1/quant/coins/risk?horizon=24h` (vol-target multiplier)
- **Backtest** — `GET /api/v1/backtesting/funding?symbol=ZEREBRO&exchange=hyperliquid` (hourly funding since 2023-05 or listing) and `GET /api/v1/backtesting/klines` (Hyperliquid daily candles back to the 2023 launch or listing; 1m bars since 2026-03-30)
