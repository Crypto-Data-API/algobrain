...
**Palladium Network** (PLLD) is a pioneering project that merges the transparency and efficiency of blockchain technology with the tangible value of real-world assets. It ranks **#482** by market capitalization.
...
| **Market Cap Rank** | #482 |
| **Market Cap** | $43.63M |
| **Current Price** | $0.8414 |
| **Categories** | Ethereum Ecosystem |
| **Website** | [https://plld.net/](https://plld.net/) |
...
The team behind Palladium Network brings a combination of experience in crypto markets, real estate, and technology, working with transparency and dedication to sustainable growth. The project's presence on platforms like TradeOgre and CoinPaprika, along with its ongoing efforts ...
...
| Metric | Value |
|---|---|
| **Circulating Supply** | 51.85M PLLD |
| **Total Supply** | 52.64M PLLD |
| **Max Supply** | 52.64M PLLD |
| **Fully Diluted Valuation** | $44.29M |
...
| Metric | Value |
|---|---|
| **All-Time High** | $5.83 (2026-01-15) |
| **Current vs ATH** | -85.55% |
| **All-Time Low** | $0.2212 (2025-12-31) |
| **Current vs ATL** | +281.05% |
| **24h Change** | -1.50% |
| **7d Change** | -1.65% |
| **30d Change** | -3.38% |
| **1y Change** | +0.00% |
...
| Chain | Address |
|---|---|
| Ethereum | `0xfc8dcfca8a37a855e352098af205b3a537b6b026` |
...
|---|---|
| **Website** | [https://plld.net/](https://plld.net/) |
| **Twitter** | [@DDTechGroup](https://twitter.com/DDTechGroup) |
| **Whitepaper** | [https://plld.net/whitepaper](https://plld.net/whitepaper) |
...
|---|---|
| **24h Volume** | $396,697.00 |
| **Market Cap Rank** | #482 |
| **24h Range** | $0.8377 — $0.8548 |
