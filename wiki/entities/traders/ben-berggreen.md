...
updated: 2026-04-07
status: good
tags: [traders, person, itpm, quantitative, long-short-equity, asset-management]
entity_type: person
...
Berggreen was educated in aeronautical science and began his career as a cargo pilot flying planes in the Caribbean. He developed an interest in trading in the mid-1990s and made the transition to finance with no business background (Source: [[itpm-trading-legends-ben-berggreen]]).
...
Moved to the West Coast and joined Tradewinds Global Investors (a Nuveen affiliate, ~$40 billion). Ran their Asian desk for seven years; the Asian portion was approximately $10 billion (Source: [[itpm-trading-legends-ben-berggreen]]).

## Key Insights

### Large Funds vs. Small Funds

Berggreen provides sharp commentary on the difference between managing billions and trading a personal account:

- **Large funds** are like "super tankers" — it can take months to build or exit a position in smaller markets. Compliance is intense, and new positions must be approved by investment boards. Much of the trading is adjusting around core positions (overweight, underweight, neutral) rather than initiating new ones (Source: [[itpm-trading-legends-ben-berggreen]]).
- **Small funds** are like "speedboats" — flexible, fast, able to access smaller companies that big funds cannot invest in due to regulatory constraints.

### The Quant Shift Creates Retail Opportunity

Berggreen observes a definitive industry shift toward AI and [[algorithmic-trading|algorithmic processes]]. Hedge funds now prioritize programming skills (C++, multiple coding languages) over investment knowledge when hiring. The old-school skill set of finding investment opportunities is "almost non-existent" in hedge fund hiring (Source: [[itpm-trading-legends-ben-berggreen]]).

This creates a sweet spot for retail traders: the 1–6 month horizon where qualitative, subjective human judgment matters more than algorithms. Quant approaches dominate short-term timeframes, and large funds are "closet indexers" at longer horizons. The middle ground is where retail traders can compete (Source: [[itpm-trading-legends-ben-berggreen]]).

## Trading Philosophy

1. **Have a systematic process** — without one, "you're just winging it." It doesn't need to be as rigid as a hedge fund's thousand-line codebase, but it must be consistent and repeatable.
...
- [[itpm-trading-legends-ben-berggreen]] — Full interview with Anton Kreil covering career, fund comparisons, and retail trading philosophy
