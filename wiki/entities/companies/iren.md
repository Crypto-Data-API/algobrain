...
aliases: ["IREN", "IREN Limited", "Iris Energy"]
ticker: "IREN"
exchange: "NASDAQ"
sector: "Information Technology"
industry: "Data Centers / Bitcoin Mining / AI Compute"
sp500: false
options_liquidity_tier: "Tier 2 - High Liquidity"
options_volume: "High"
related: ["[[artificial-intelligence]]", "[[bitcoin]]", "[[crypto-trading]]", "[[implied-volatility]]", "[[options]]", "[[ai-data-centers]]", "[[riot-platforms]]"]
---

IREN Limited (NASDAQ: IREN), formerly Iris Energy, is an Australian-founded data-center company that runs renewable-energy-powered facilities for [[bitcoin]] mining and, increasingly, AI/HPC cloud compute. The November 2025 signing of a $9.7 billion AI-cloud agreement with Microsoft transformed the investment story from "bitcoin miner" to "AI data-center operator," driving an enormous share-price re-rating. For traders it is a high-beta, high-[[implied-volatility]] name sitting at the intersection of the bitcoin and AI-infrastructure themes.

## Business Overview

IREN owns and operates purpose-built data centers (notably large sites in Texas and British Columbia) powered largely by renewable energy. Its two revenue engines are: **bitcoin mining** (hash-rate generating BTC, exposed to bitcoin price, network difficulty, and power costs) and a fast-growing **AI cloud / HPC** business (GPU compute leased to AI customers). The strategic pivot leverages IREN's core asset — low-cost power and ready-to-energize data-center capacity — which is the binding constraint for AI compute. Power economics, capex funding, and execution on converting/expanding capacity are the key value drivers; like all miners it is capital-intensive and dilutive when raising growth capital.

## Business Segments / Products

IREN is best understood as a **vertically integrated power-and-compute platform** rather than a pure miner. The thesis hinges on the fact that the scarce input for both bitcoin mining and AI is the same: large, grid-connected, low-cost power with ready-to-energize land and cooling. IREN sits on a pipeline of secured power capacity and chooses, at the margin, whether each megawatt earns more hashing bitcoin or hosting GPUs.

| Segment | What it is | Key economics | Trading sensitivity |
|---|---|---|---|
| **Bitcoin mining (self-mining)** | Company-owned ASIC fleet hashing for block rewards | BTC price, network difficulty, fleet efficiency (J/TH), all-in power cost (¢/kWh) | High [[bitcoin]] beta; post-halving margin compression |
...
IREN competes on two fronts: against bitcoin miners for power and efficiency, and against neocloud / AI-data-center operators for GPU compute customers. Its differentiation is the Microsoft anchor contract plus a large pipeline of self-developed, renewable-powered capacity.

| Company | Ticker | Primary model | AI/HPC pivot status | Notes |
|---|---|---|---|---|
| **IREN** | IREN | Mining + AI cloud | Anchor hyperscaler contract (Microsoft) | Renewable-powered; AU-founded, US-listed |
| [[mara]] (Marathon) | MARA | Largest US self-miner | Early HPC/edge experiments | Big BTC treasury; mining-first |
| [[riot-platforms]] | RIOT | Texas self-mining at scale | Converting capacity to AI/HPC | Large Texas power footprint |
...
**Bull case**
- The Microsoft contract validates IREN as a credible AI-infrastructure operator, not just a miner — justifying a re-rate toward neocloud multiples.
- Secured, low-cost, renewable power is the genuinely scarce asset in the AI buildout; IREN owns a pipeline of it.
- Optionality: each megawatt can flex between mining and AI to chase the higher return.
- AI cloud revenue is ramping (the March 2026 quarter showed it is no longer trivial), de-risking the narrative.
...
IREN does not lend itself to a clean P/E (earnings are dominated by BTC marks and ramping AI capex). Traders and analysts watch a qualitative stack of drivers:

- **BTC-beta** — how much of the equity move is just leveraged [[bitcoin]] exposure.
...
- **Catalysts:** AI-contract announcements and customer wins, quarterly results (AI cloud revenue, mining output, power costs), bitcoin price moves, capacity-expansion and financing news, GPU supply, index/ETF inclusion changes.
- **Retail behavior:** thematic momentum name; prone to sharp short squeezes and headline-driven gaps in both directions.
...
- IREN-Microsoft $9.7B agreement — https://iren.com/resources/blog/iren-signs97-billion-agreement-with-microsoft-to-deploy-ai-cloud-infrastructure
- Bloomberg coverage — https://www.bloomberg.com/news/articles/2025-11-03/microsoft-signs-9-7-billion-ai-cloud-deal-with-australia-s-iren
- IREN Q3 FY2026 10-Q — https://www.stocktitan.net/sec-filings/IREN/10-q-iren-ltd-quarterly-earnings-report-47751ec07c5b.html
