...
- **New CEO** — Craig S. Donohue became CEO effective 2025-05-07, succeeding Fredric Tomczyk. Donohue is a derivatives-industry veteran who previously ran [[cme-group|CME Group]] as CEO for eight years (through 2012) and later chaired the OCC — a notable hire-from-the-rival given Cboe/CME's long history.
- **Record financials** — Q2 2025 net revenue hit a record $587 million, and Cboe closed FY2025 with another record year of net revenue and adjusted earnings, driven by the derivatives complex (SPX, VIX, and especially 0DTE options demand). Q4 2025 materials highlighted record revenue growth "amid derivatives boom."
- **0DTE structural shift** — by 2025, zero-days-to-expiration contracts accounted for over half of SPX options volume per Cboe earnings commentary, and management (Global Derivatives head Catherine Clay) publicly argued the volume mix is sustainable, citing retail broker-dealer partnerships and international (especially APAC overnight) demand.
- **Toward 24-hour markets** — Cboe announced plans (February 2025) to extend US equities trading on its EDGX exchange to 24 hours a day, five days a week, targeting launch in 2026 pending regulatory readiness; SPX and VIX options already trade in extended global trading hours (GTH), where overnight volume keeps setting records.

For traders the practical upshot: Cboe is the venue and data source for the dominant index-volatility complex (SPX/VIX/0DTE), its GTH session is where overnight US-index price discovery increasingly happens, and its product pipeline (options on VIX futures, credit and crypto vol indices, 24x5 equities) keeps creating new instruments and basis relationships to trade.
...
- Cboe official site — https://www.cboe.com
- Cboe Global Markets Q2 2025 earnings release (record $587M net revenue) — https://www.sec.gov/Archives/edgar/data/0001374310/000162828025037143/cboe-20250801xex991.htm
- Yahoo Finance / etf.com, "Cboe Global Markets Names Craig Donohue as New CEO" (2025) — https://www.etf.com/sections/news/cboe-global-markets-names-craig-donohue-new-ceo
- Investing.com, "Cboe Q4 2025 presentation slides: Record revenue growth amid derivatives boom" — https://www.investing.com/news/company-news/cboe-q4-2025-presentation-slides-record-revenue-growth-amid-derivatives-boom-93CH-4491181
- Exchange history: Cboe corporate history (1973 founding, 1993/2003 VIX methodology, 2004/2006 VIX futures and options)
