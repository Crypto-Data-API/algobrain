...
Network effects are one of the five classic sources of economic moat in the Morningstar framework. They are the strongest because they are self-reinforcing, but they rarely act alone — they compound with switching-costs and scale.
...
- The reverse is symmetric and brutal: if the incumbent's n starts falling, value falls with the square, accelerating departures — the "tipping out" dynamic seen in MySpace, BlackBerry Messenger, and exchanges that lose liquidity.
