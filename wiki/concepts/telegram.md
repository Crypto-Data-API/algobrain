...
domain: [crypto, behavioral-finance]
difficulty: beginner
---

Telegram is a cloud-based messaging platform founded in 2013 by Pavel and Nikolai Durov. Beyond consumer messaging, it has become the **de facto coordination layer for crypto trading communities** — projects, signal groups, trading bots, and (frequently) [[pump-and-dump]] schemes — and it is the parent ecosystem of the [[ton|TON]] blockchain. For traders it matters as both a real-time information source and a venue for organised [[market-manipulation]].
...
Telegram's reach and pseudonymity make it the primary venue for coordinated [[pump-and-dump]] and "rug pull" operations: an organiser accumulates a low-float token, a group is instructed to buy at a set time, latecomers provide exit liquidity for insiders, and the price collapses. Because these schemes are explicit [[market-manipulation]], following Telegram "calls" is a structurally losing trade for the typical late participant — the edge is held by the organisers and earliest insiders. Smart-money analysis uses Telegram as a *contrarian* and *flow-timing* signal, not as a buy list.
...
- Telegram public documentation and API references.
- General reporting and academic work on coordinated pump-and-dump schemes on Telegram and Discord (e.g. studies of crypto pump-group activity).
