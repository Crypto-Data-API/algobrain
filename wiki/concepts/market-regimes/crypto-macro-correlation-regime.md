...
- **Signal:** [[nasdaq|Nasdaq]]/[[sp500|S&P]] dropping, [[dxy|DXY]] rising, gold bid as a haven, treasury yields and VIX spiking — the classic risk-off cross-asset signature. When BTC's rolling correlation to equities is high, BTC *follows the selling* rather than offering shelter (Source: [[2026-06-03-cryptodataapi-14-basket-regime-framework]]).
