...
| 29 | `combinations/stop-hunting-and-liquidity-sweeps.md` | STRATEGY | Entry strategy exploiting stop-hunt mechanics; markets=[forex,crypto,futures] | no |
| 30 | `combinations/structural-forced-selling.md` | STRATEGY | Strategy exploiting forced-seller flows with entry triggers; markets=[stocks,bonds] — equity-framed; flag | no |
| 31 | `combinations/trend-plus-tail-hedge.md` | STRATEGY | Deployable combination of trend following + tail hedge; markets=[futures] but crypto-applicable | no |
...
| 33 | `conversion-reversal-arbitrage.md` | STRATEGY | Crypto options put-call parity arb with specific entry/exit; genuine edge-seeking on Deribit | no |
...
| 35 | `delta-hedged-options.md` | STRATEGY | Volatility isolation via delta-hedging with specific entry/size/management rules; genuine strategy | no |
...
| 38 | `fundamental-analysis/news-trading.md` | STRATEGY | Event-driven news/catalyst trading with entry logic; markets=[stocks,forex,crypto] | no |
...
| 43 | `options-income.md` | STRATEGY | Systematic options-income class with edge analysis, entry/exit/regime gating on Deribit; already has "## Edge Source" prose | no |
| 44 | `options-premium-selling.md` | STRATEGY | Core short-vol crypto strategy with edge source prose already present; needs frontmatter fields | no |
...
| 47 | `premium-selling-systematic.md` | STRATEGY | Mechanical crypto premium-selling with DVOL gate, 16d, 35-DTE rules; fully deployable; already has edge prose | no |
...
| 49 | `quantitative/tail-risk-hedging.md` | STRATEGY | Crypto tail-hedge strategy with specific OTM put accumulation rules on Deribit; deployable | no |
| 50 | `quantitative/vix-trading.md` | STRATEGY | Crypto vol trading (DVOL) with straddle/strangle entry logic; crypto-native reframe already done | no |
...
| 53 | `tail-hedging.md` | STRATEGY | Tail-hedging discipline with specific OTM put strategy on Deribit; deployable; complements tail-risk-hedging | no |
| 54 | `technical-analysis/0dte-trading.md` | STRATEGY | 0DTE crypto options trading with entry/sizing/management rules; deployable on Deribit | no |
...
| 65 | `technical-analysis/channel-breakout.md` | STRATEGY | Breakout strategy with specific channel-entry rules; generic but deployable in crypto | no |
...
| 75 | `technical-analysis/macd-crossover.md` | STRATEGY | MACD crossover is a deployable signal-based strategy; crypto-applicable | no |
...
| 77 | `technical-analysis/opening-range-breakout.md` | STRATEGY | ORB is a deployable intraday entry system; crypto-applicable on session open | no |
| 78 | `technical-analysis/options-selling.md` | STRATEGY | Deployable options-selling framework with entry/regime/exit for Deribit; genuine strategy | no |
...
| 81 | `technical-analysis/rate-of-change.md` | STRATEGY | ROC momentum strategy with crossover entry rules; deployable in crypto | no |
...
| 85 | `technical-analysis/rsi-divergence.md` | STRATEGY | RSI divergence is a deployable reversal signal strategy; crypto-applicable | no |
...
| 92 | `technical-analysis/support-resistance-breakout.md` | STRATEGY | Deployable S/R breakout strategy with volume-confirmation rules | no |
...
| 94 | `technical-analysis/turtle-trading.md` | STRATEGY | Turtle system is a fully deployable trend-following strategy; crypto-native reframe done; high priority | no |
| 95 | `technical-analysis/vertical-spread.md` | STRUCTURE | Vertical spread options structure (generic); Wave 3 — leave as-is | no |
| 96 | `technical-analysis/volatility-breakout.md` | STRATEGY | ATR/NR7 volatility breakout system with entry rules; deployable in crypto | no |
| 97 | `technical-analysis/wheel-strategy.md` | STRUCTURE | Wheel options income structure (CSP + CC cycle); Wave 3 — leave as-is | no |
| 98 | `vix-calls.md` | STRATEGY | Crypto long-vol overlay with specific Deribit structures and entry/sizing logic; deployable | no |
| 99 | `zero-dte-options.md` | STRATEGY | 0DTE overview + deployment structures; complements 0dte-trading.md; deployable | no |
